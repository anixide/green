...
const navbar = ({ fixed }) => {
    ...
    return (
        ...
        <div className="bg-blue-100 shadow-lg">
            <nav className="bg-blue-100 hidden md:block">
                <div className="flex justify-between max-w-md container mx-auto">
                    ...
                    <ul className="flex justify-between items-center">
                        <li className="mx-4 my-2 px-3 py-2 text-center items-center font-semibold text-gray-700 hover:text-gray-900">
                            <Link href="/">
                                Home
                            </Link>
                        </li>
            ...
            <nav className="bg-blue-100 md:hidden  mx-auto">
                <div className="flex flex-col justify-around container mx-auto">
                    <div className="flex justify-between px-2 py-4">
                        ...
                        <button
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M32 16C32 16.552 31.4741 17 30.8235 17H13.1765C12.5271 17 12 16.552 12 16C12 15.448 12.5271 15 13.1765 15H30.8235C31.4741 15 32 15.448 32 16ZM13.1765 23C12.5259 23 12 22.552 12 22C12 21.448 12.5259 21 13.1765 21H30.8235C31.4729 21 32 21.448 32 22C32 22.552 31.4729 23 30.8235 23H13.1765ZM30.8235 29C31.4741 29 32 28.552 32 28C32 27.448 31.4741 27 30.8235 27H13.1765C12.5271 27 12 27.448 12 28C12 28.552 12.5271 29 13.1765 29H30.8235Z" fill="#252A31"/>
                            </svg>
                            </i>
                        </button>
                        <li className="hidden px-4 mx-2 list-none py-2 text-center items-center cursor-pointer rounded-lg bg-green-400 text-gray-100 font-semibold ">
                            <Link href="/startNow">
                                Start now
                            </Link>
                        </li>
                    ...
                    <div
                        className={
                        "lg:flex flex-grow items-center space-between self-center" +
                        (navbarOpen ? " flex" : " hidden")
                      }
                      id="example-navbar-danger">

                        <ul className="flex flex-col lg:flex-row list-none self-center">
                            <li className="my-2 mx-4 my-2 px-3 py-2 text-center items-center font-semibold text-gray-700 hover:text-gray-900">
                                <Link href="/">
                                    Home
                                </Link>
                            </li>
                            ...
                            <li className="my-2  px-6 mr-2 py-2 text-center items-center cursor-pointer rounded-lg bg-green-400 text-gray-100 font-semibold ">
                                <Link href="/startNow">
                                    Start now
                                </Link>
                            </li>
